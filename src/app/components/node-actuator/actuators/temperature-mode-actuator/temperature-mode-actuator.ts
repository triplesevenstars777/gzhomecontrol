...
@Component({
  selector: 'temperature-mode-actuator',
  templateUrl: 'temperature-mode-actuator.html',
  styleUrl : './temperature-mode-actuator.scss',
  standalone: false
})
export class TemperatureModeActuatorComponent implements OnInit, OnDestroy {
